...
\Function{shiftSharpTurn}{$ V, W$}
    ...
    \If {$ \norm{\vec{v_1}} > \norm{\vec{v_2}} $} \label{shiftSharpTurn:begin_ifs}
        \State $ Q_1 \gets P_1$
    \Else
...
Rozeberme si ještě detailněji některé detaily uvedené procedury. Na řádcích
...
Stejně jako v případě funkce $ \operatorname{shiftDisk} $ musíme ještě nakonec
