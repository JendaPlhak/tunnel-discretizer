...
\subsection{Hledání minimálního řezu} \label{subsec:min_cut}
...
zmenšíme úhel odklonu $ \theta $ od aktuální normály a celý proces zopakujeme.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=65mm]{img/min_cuts.png}
...
$ \gamma $ z předchozí kapitoly, se kterou pak počítám jak bylo popsáno.
